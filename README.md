...
## Requirements
* Nintendo Switch 2
* An Android phone (I've only tested with a Samsung Galaxy S21+)
...
* A friend (or alt account) can scan one of your QR codes N times, but you will only receive one point toward your medal.
...
8. Run `./qr_loop.sh`. This will loop infinitely, doing the following:
   ...
   Note that these scripts use hard-coded pixel locations. You should adjust these via trial-and-error to work on your phone.
